  ...
  return (
    <section className="py-24 bg-[#FAFAFA]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1A1025] via-[#2D1B4E] to-[#1A1025] border border-[#A874FF]/20 p-12 md:p-20 text-center shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <ShiningButton className="text-lg px-8 py-4 rounded-full">
